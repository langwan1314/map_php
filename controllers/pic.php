...
class Pic extends IController
{
	...
	function upload()
	{
		...
		//目录散列
		$dir = WM::$app->config['upload'].'/'.date('Y')."/".date('m')."/".date('d');
		$upObj->setDir($dir);
	...
	public function upload_json()
	{
		...
		$realpath  = WM::$app->getBasePath().'runtime/_systemjs/editor/php/upload_json.php';
	...
	public function file_manager_json()
	{
		...
		$realpath  = WM::$app->getBasePath().'runtime/_systemjs/editor/php/file_manager_json.php';
		include($realpath);
	}
