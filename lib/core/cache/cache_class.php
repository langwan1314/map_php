...
class ICache
{
	...
	public function __construct($cacheType = '')
	{
		...
		$this->expire    = isset(WM::$app->config['cache']['expire'])  ? WM::$app->config['cache']['expire']  : $this->expire;
		$this->timeout   = isset(WM::$app->config['cache']['timeout']) ? WM::$app->config['cache']['timeout'] : $this->timeout;
