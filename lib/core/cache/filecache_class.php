...
class IFileCache implements ICacheInte
{
	...
	{
		$this->cachePath = isset(WM::$app->config['cache']['path']) ? WM::$app->config['cache']['path'] : $this->cachePath;
		$this->cacheExt  = isset(WM::$app->config['cache']['ext'])  ? WM::$app->config['cache']['ext']  : $this->cacheExt;
	}
