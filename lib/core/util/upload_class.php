...
class IUpload
{
	 ...
	 * @throws Exception
	 */
    public function execute($attach_type = 0)
    {
    	//总的文件上传信息
    	$info = array();
                	...
                	else
                	{
		                ...
		                else
		                {
		                    ...
		                    else
		                    {
								...
								$ur = YunUpload::uploadFile($_FILES[$field], $attach_type);
								dump($ur,1);
								$ur_img_info = pathinfo($ur['output']['url']);

								$fileInfo[$key]['name']    = $ur_img_info['basename'];
								$fileInfo[$key]['dir']     = $ur_img_info['dirname'].'/';
								$fileInfo[$key]['size']    = $_FILES[$field]['size'];
								$fileInfo[$key]['ininame'] = $_FILES[$field]['name'];
            	...
            	else
            	{
                	...
                	else
                	{
		                ...
		                else
		                {
							...
							$fileInfo[0]['name']    = $ur_img_info['basename'];
							$fileInfo[0]['dir']     = $ur_img_info['dirname'].'/';
