<?php
/**
 * @copyright Copyright(c) 2010 crycoder.com
...
abstract class IApplication
{
    ...
    /**
     * @brief 构造函数
     * @param array | string $config 配置数组或者配置文件名称
     */
    public function __construct($config)
    {
    	WM::setApplication($this);
		...
		WM::setClasses(isset($config['classes']) ? $config['classes'] : 'classes.*');
    ...
    /**
     * @brief 设置调试模式
     * @param bool $flag true开启，false关闭
     */
    private function setDebugMode($flag)
    {
		...
		set_error_handler("IException::phpError" , E_ERROR|E_STRICT|E_WARNING );
