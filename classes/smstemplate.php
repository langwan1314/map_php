...
class smsTemplate
{
	...
	public static function _addSignature($templateString, $data)
	{
		if ($data && isset($data["signature"]) && $data["signature"])
		{
			return "【".$data["signature"]."】".$templateString;
		}
		//return $templateString;
		return "【开心菜园】".$templateString;
	}
	...
	public static function sendGoods($data = null)
	{
		...
		$templateString = smsTemplate::_addSignature($templateString, $data);
	...
	{
		$templateString = "您的验证码是{mobile_code}";
		$templateString = smsTemplate::_addSignature($templateString, $data);
		return strtr($templateString,$data);
	}
