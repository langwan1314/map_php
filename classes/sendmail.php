...
class SendMail
{
	...
	public function __construct($site_config = null)
	{
		...
		{
			$phpMailerDir = WM_PATH.'core/util/phpmailer/PHPMailerAutoload.php';
	...
	public function send($to,$title,$content,$bcc = '')
	{
		...
		{
			$this->smtp->FromName= isset($this->config['name']) ? $this->config['name'] : '系统邮件';
